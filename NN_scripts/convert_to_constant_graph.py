...
if __name__ == "__main__":
  ...
  constant_graph_file = model_file.replace('model', 'model_graph').replace('.json', '.1.pb')
  ...
  cmsml.tensorflow.save_graph(constant_graph_file+'.txt', loaded_model, variables_to_constants=True)
